import 'package:deliveryapp/pages/dessertScreen.dart';
import 'package:deliveryapp/pages/PlatsScreen.dart';
import 'package:deliveryapp/pages/BoissonsScreen.dart';
    ...
    return Scaffold(
                        ...
                        Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => PlatsScreen()),);
                                },
                                child:  MenuCard(
                                imageShape: ClipOval(
                                  child: Container(
      ...
      MaterialPageRoute(builder: (context) => DessertScreen()),);
                             ...
                             GestureDetector(
                              ...
                              Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => BoissonsScreen()),);
                                },
                                child:  MenuCard(
                                imageShape: ClipPath(
